...
from src.ocr import get_text_from_pdf
...
def process_all_pdfs(pdf_dir='pdfs', output_dir='texts', language='eng'):
    '''
    ...
    for pdf_file in sorted(pdf_files):
        if process_pdf(pdf_file, output_path, language):
            processed += 1
        else:
            skipped += 1
...
def main():
    ...
    stats = process_all_pdfs(args.pdf_dir, args.output_dir, args.language)
